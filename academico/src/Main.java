...
public class Main {
    public static void main(String[] args) {
        ...
        Student newStudent = new Student(12345, "Maria", "maria@gmail.com");
        Student newStudent1 = new Student(4321, "Jhon", "jhon@gmail.com");
        ...
        Teacher newTeacher = new Teacher(125, "Daniel", "Matematicas");
        teacherController.insertNewTeacher(newTeacher);
        teacherController.displayAllTeachers();

        Course newCourse = new Course(124, "Ciencia", "...", true, newTeacher.getId());
        ...
        Grades grades1 = new Grade(2,2,1, 80.50);
        Grades grades2 = new Grade(3,2,1, 60.0);
        ...
        System.out.println("parcial elaborado por Natalia Martinez Arevalo");
